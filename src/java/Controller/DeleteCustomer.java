...
public class DeleteCustomer extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            UserDAO UserDAO = new UserDAO(); // Replace with the actual DAO class name

            // Call the delete method
            UserDAO.deleteByUserID(userID);

            // Redirect to a confirmation page or list of customers
            response.sendRedirect("customer"); // Adjust the redirect as needed
