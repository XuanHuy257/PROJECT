 ...
 * @author sontu
 */
public class MktChangeProductSizeToUpdateSellPrice extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ProductDetailforMKT productDetailforMKT = daoProduct.getProductDetailforMKTbyIDandSize(productId, sizeName);
            ...
            request.getRequestDispatcher("mkt-update-sell-price.jsp").forward(request, response);
        }
    } 
