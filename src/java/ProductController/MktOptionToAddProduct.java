 ...
 * @author sontu
 */
public class MktOptionToAddProduct extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            List<Size> allSizeName = daoSize.getAllSize();
            ...
            request.setAttribute("allSizeName", allSizeName);
            request.setAttribute("allFeature", allFeature);
            request.getRequestDispatcher("mkt-add-product.jsp").forward(request, response);
        }
    } 
