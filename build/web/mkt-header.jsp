<%-- 
    Document   : mkt-header
    Created on : Oct 1, 2024, 11:00:25 AM
    Author     : 
--%>
...
<html>
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark" style="background-color: #384aeb">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="MarketingDashBoard"
               .jsp">Marketing</a>
            <!-- Sidebar Toggle-->
