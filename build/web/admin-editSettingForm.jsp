...
<html lang="en">
    <head>
        ...
        <title>Edit Setting - SB Admin</title>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            ...
                            <li class="breadcrumb-item"><a href="settingsList">Settings</a></li>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form action="editSettingForm" method="post">
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                            <label for="settingID" class="form-label"><strong>Setting ID</strong></label>
                                            <input type="text" class="form-control" id="settingID" name="settingID" value="${setting.id}" readonly>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row mb-3">  
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="number" class="form-control" id="order" name="order" value="${setting.order}" required>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a href="settinglist" class="btn btn-secondary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
